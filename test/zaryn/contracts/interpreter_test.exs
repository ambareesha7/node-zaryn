                                      ...
                                      {:., [line: 3],
                                       [
                                         {:__aliases__,
                                          [
                                            alias:
                                              Zaryn.Contracts.Interpreter.TransactionStatements
                                          ], [:TransactionStatements]},
                                         :add_zaryn_transfer
                                       ]},
                                      [line: 3],
                ...
                conditions: %{
                  inherit: %Conditions{
                    zaryn_transfers:
                      {:==, _,
                       [
                         {:get_in, _, [{:scope, _, nil}, ["next", "zaryn_transfers"]]},
                         {:%{}, _,
                          [
             ...
             secret:
               {:>=, [line: 2],
                [
                  {{:., [line: 2],
                    [
                      {:__aliases__, [alias: Zaryn.Contracts.Interpreter.Library], [:Library]},
                      :size
                    ]}, [line: 2],
                   [
