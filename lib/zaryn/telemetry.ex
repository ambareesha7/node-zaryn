defmodule Zaryn.Telemetry do
  ...
  def metrics do
    [
      ...
      # Zaryn
      summary("zaryn.election.validation_nodes.duration", unit: {:native, :millisecond}),
      summary("zaryn.election.storage_nodes.duration", unit: {:native, :millisecond}),
      summary("zaryn.mining.proof_of_work.duration", unit: {:native, :millisecond}),
      summary("zaryn.mining.pending_transaction_validation.duration",
        unit: {:native, :millisecond}
      ),
      summary("zaryn.mining.fetch_context.duration", unit: {:native, :millisecond}),
      summary("zaryn.mining.full_transaction_validation.duration",
        unit: {:native, :millisecond}
      ),
      summary("zaryn.contract.parsing.duration", unit: {:native, :millisecond}),
      summary("zaryn.transaction_end_to_end_validation.duration",
        unit: {:native, :millisecond}
      ),
      summary("zaryn.p2p.send_message.duration", unit: {:native, :millisecond}),
      summary("zaryn.crypto.tpm_sign.duration", unit: {:native, :millisecond})
    ]
  end
end
