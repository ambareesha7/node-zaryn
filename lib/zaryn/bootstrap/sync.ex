defmodule Zaryn.Bootstrap.Sync do
  @moduledoc false
  ...
  alias Zaryn.P2P
  alias Zaryn.P2P.Message.BootstrappingNodes
  alias Zaryn.P2P.Message.EncryptedStorageNonce
  alias Zaryn.P2P.Message.GetBootstrappingNodes
  alias Zaryn.P2P.Message.GetStorageNonce
  alias Zaryn.P2P.Message.ListNodes
  alias Zaryn.P2P.Message.NodeList
  alias Zaryn.P2P.Message.NotifyEndOfNodeSync
  ...
  @out_of_sync_date_threshold Application.compile_env(:zaryn, [
                                __MODULE__,
                                :out_of_sync_date_threshold
                              ])

  @genesis_daily_nonce_seed Application.compile_env!(:zaryn, [
                              NetworkInit,
