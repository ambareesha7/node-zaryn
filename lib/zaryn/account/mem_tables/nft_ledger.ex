defmodule Zaryn.Account.MemTables.NFTLedger do
  @moduledoc false

  @ledger_table :zaryn_nft_ledger
  @unspent_output_index_table :zaryn_nft_unspent_output_index
  ...
  ## Examples
      ...
      iex> { :ets.info(:archethic_nft_ledger)[:type], :ets.info(:zaryn_nft_unspent_output_index)[:type] }
      { :set, :bag }
  """
  ...
  ## Examples
      ...
      iex> { :ets.tab2list(:zaryn_nft_ledger), :ets.tab2list(:archethic_nft_unspent_output_index) }
      {
        [
