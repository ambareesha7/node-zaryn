defmodule Zaryn.Governance.Code.Proposal.Validator do
  @moduledoc """
  The Zaryn Code Proposal Validator task is to validate Zaryn Code Proposal.
  It is designed to run supervised by an os process with witch it communicates
  trough stdin/stdout.
  """
  require Logger

  alias Zaryn.Benchmark.Balance
  alias Zaryn.Playbook.ZARYN
  alias Zaryn.Utils
