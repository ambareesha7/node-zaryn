defmodule Zaryn.Governance.Code.Proposal.Parser do
  @moduledoc false
  ...
  @doc ~S"""
    ...
    ## Examples
      ...
      ...> Changes:
      ...> diff --git a/lib/zaryn/governance.ex b/lib/zaryn/governance.ex
      ...> index 30787f1..6535f52 100644
      ...> --- a/lib/zaryn/governance.ex
      ...> +++ b/lib/zaryn/governance.ex
      ...> @@ -1,107 +1,107 @@"
  ...
  ## Examples
      ...
      ...> "
      ...> |> Parser.get_changes()
      {:ok, "diff --git a/lib/zaryn/governance.ex b/lib/zaryn/governance.ex
       index 30787f1..6535f52 100644
       --- a/lib/zaryn/governance.ex
       +++ b/lib/zaryn/governance.ex
       @@ -1,107 +1,107 @@" }
  ...
  ## Examples
      ...
      ...> --- a/mix.exs
      ...> +++ b/mix.exs
      ...> @@ -4,7 +4,7 @@ defmodule Zaryn.MixProject do
      ...>   def project do
      ...>     [
      ...>       app: :zaryn,
      ...> -      version: \"0.7.1\",
      ...
      ...>       deps_path: \"deps\",
      ...> @@ -53,7 +53,7 @@ defmodule Zaryn.MixProject do
  ...
  ## Examples
      iex> "diff --git a/lib/zaryn/supervisor.ex b/lib/zaryn/supervisor.ex
      ...> index 124088f..c3add90 100755
      ...> --- a/lib/zaryn/supervisor.ex"
      ...> |> Parser.list_files()
      ["lib/zaryn/supervisor.ex"]
  """
