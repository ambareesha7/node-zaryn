defmodule Zaryn.P2P.MemTable do
  @moduledoc false

  @discovery_table :zaryn_node_discovery
  @nodes_key_lookup_table :zaryn_node_keys
  @availability_lookup_table :zaryn_available_nodes
  @authorized_nodes_table :zaryn_authorized_nodes
  ...
  ## Examples
      ...
      iex> {
      ...>    :ets.info(:zaryn_node_discovery)[:type],
      ...>    :ets.info(:zaryn_node_keys)[:type],
      ...>    :ets.info(:zaryn_available_nodes)[:type],
      ...>    :ets.info(:zaryn_authorized_nodes)[:type],
      ...>  }
      { :set, :set, :set, :set }
  """
  ...
  ## Examples
      ...
      iex> {
      ...>   :ets.tab2list(:zaryn_node_discovery),
      ...>   :ets.tab2list(:zaryn_available_nodes),
      ...>   :ets.tab2list(:zaryn_authorized_nodes),
      ...>   :ets.tab2list(:zaryn_node_keys)
      ...>  }
      {
        # Discovery table
        [{
