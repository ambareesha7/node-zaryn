defmodule Zaryn.P2P.GeoPatch.GeoIP.IP2LocationImpl do
  @moduledoc false

  @table_name :ip2location

  alias Zaryn.P2P.GeoPatch.GeoIP
  ...
  def get_coordinates(ip) when is_tuple(ip) do
    unless metadata_loaded?() do
      ip_db_file = Application.app_dir(:zaryn, "/priv/p2p/IP2LOCATION-LITE-DB5.BIN")
