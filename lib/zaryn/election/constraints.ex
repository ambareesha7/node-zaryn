defmodule Zaryn.Election.Constraints do
  @moduledoc """
  ...
  alias Zaryn.Election.StorageConstraints
  alias Zaryn.Election.ValidationConstraints

  @table_name :zaryn_election_constraints
