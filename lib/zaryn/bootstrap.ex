defmodule Zaryn.Bootstrap do
  ...
  @genesis_seed Application.compile_env(:zaryn, [NetworkInit, :genesis_seed])
  @genesis_pools Application.compile_env(:zaryn, [NetworkInit, :genesis_pools])
  ...
  defp post_bootstrap(opts) do
    ...
    :persistent_term.put(:zaryn_up, :up)
  end
