defmodule Zaryn.TransactionChain.TransactionData do
  @moduledoc """
  ...
  - Ledger: Movement operations on ZARYN, NFT or Stock ledger
  ...
  @doc ~S"""
    ...
    ## Examples
      ...
      iex> %TransactionData{
      ...>    code: "actions do new_transaction(:transfer) |> add_zaryn_transfer(to: 892B5257A038BBB14F0DD8734FA09A50F4F55E8856B72F96F2A6014EEB8A2EAB72, amount: 10.5) end",
      ...
      0, 0, 0, 147,
      # Code
      "actions do new_transaction(:transfer) |> add_zaryn_transfer(to: 892B5257A038BBB14F0DD8734FA09A50F4F55E8856B72F96F2A6014EEB8A2EAB72, amount: 10.5) end",
      # Content size
      0, 0, 0, 54,
      # Content
