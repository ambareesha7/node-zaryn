defmodule Zaryn.TransactionChain.Transaction.ValidationStamp.LedgerOperations.TransactionMovement do
  @moduledoc """
  ...
  - type: asset type (ie. ZARYN or NFT)
  """
  @type t() :: %__MODULE__{
  ...
  @spec to_map(t()) :: map()
  def to_map(%__MODULE__{to: to, amount: amount, type: :ZARYN}) do
    %{
      to: to,
      amount: amount,
      type: "ZARYN"
