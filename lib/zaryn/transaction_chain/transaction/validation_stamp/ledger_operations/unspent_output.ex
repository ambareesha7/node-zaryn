defmodule Zaryn.TransactionChain.Transaction.ValidationStamp.LedgerOperations.UnspentOutput do
  @moduledoc """
  ...
  alias Zaryn.TransactionChain.Transaction.ValidationStamp.LedgerOperations.TransactionMovement.Type,
  ...
  @spec to_map(t()) :: map()
  def to_map(%__MODULE__{from: from, amount: amount, type: :ZARYN, reward?: reward?}) do
    %{
      from: from,
      amount: amount,
      type: "ZARYN",
