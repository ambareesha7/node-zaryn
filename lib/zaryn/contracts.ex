defmodule Zaryn.Contracts do
  @moduledoc """
  Handle smart contracts based on a new language running in an custom interpreter for Zaryn network.
          ...
          conditions: %{
            inherit: %Conditions{
              content: {:==, [line: 2], [
                true,
                {
                  {:., [line: 2], [{:__aliases__, [alias: Zaryn.Contracts.Interpreter.Library], [:Library]}, :regex_match?]},
                  [line: 2],
              ...
              actions: {:__block__, [], [
                {
                  ...
                  [
                    {:scope, [line: 7], nil},
                    {:update_in, [line: 7], [{:scope, [line: 7], nil}, ["contract"], {:&, [line: 7], [{{:., [line: 7], [{:__aliases__, [alias: Zaryn.Contracts.Interpreter.TransactionStatements], [:TransactionStatements]}, :set_type]}, [line: 7], [{:&, [line: 7], [1]}, "hosting"]}]}]}
                  ]
                },
                {
                  :=,
                  ...
                  [
                    {:scope, [line: 8], nil},
                    {:update_in, [line: 8], [{:scope, [line: 8], nil}, ["contract"], {:&, [line: 8], [{{:., [line: 8], [{:__aliases__, [alias: Zaryn.Contracts.Interpreter.TransactionStatements], [:TransactionStatements]}, :set_content]}, [line: 8], [{:&, [line: 8], [1]}, "Mr.X: 10, Mr.Y: 8"]}]}]}
                  ]
                }
              ]},
    ...
    case Interpreter.parse(contract_code) do
      {:ok,
       contract = %Contract{
        ...
        :telemetry.execute([:zaryn, :contract, :parsing], %{
