defmodule Zaryn.SharedSecrets.MemTables.OriginKeyLookup do
  @moduledoc """
  ...
  @origin_key_table :zaryn_origin_keys
  @origin_key_by_type_table :zaryn_origin_key_by_type
  ...
  ## Examples
      ...
      iex> { :ets.info(:zaryn_origin_keys)[:type], :ets.info(:zaryn_origin_key_by_type)[:type] }
      { :set, :bag }
  """
