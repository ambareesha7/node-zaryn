defmodule Zaryn do
  ...
  defp handle_balance_result({:ok, %Balance{zaryn: zaryn_balance, nft: nft_balances}}) do
    %{zaryn: zaryn_balance, nft: nft_balances}
  end

  defp handle_balance_result(_), do: %{zaryn: 0.0, nft: %{}}
