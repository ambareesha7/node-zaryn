defmodule ZarynWeb.GraphQLSchema.TransactionType do
  @moduledoc false

  use Absinthe.Schema.Notation

  import_types(ZarynWeb.GraphQLSchema.DateTimeType)
  import_types(ZarynWeb.GraphQLSchema.HexType)
  import_types(ZarynWeb.GraphQLSchema.ContentType)
  import_types(ZarynWeb.GraphQLSchema.AddressType)

  alias ZarynWeb.GraphQLSchema.Resolver

  @desc "[Transaction] represents a unitary transaction in the Zaryn network."
  ...
  object :ledger do
    field(:zaryn, :zaryn_ledger)
    field(:nft, :nft_ledger)
  end

  @desc "[ZARYNTransfer] represents the an asset transfer"
  object :zaryn_transfer do
    field(:to, :hex)
    field(:amount, :float)
  end
  ...
  @desc "[ZARYNLedger] represents the transfers to perform on the ZARYN ledger"
  object :zaryn_ledger do
    field(:transfers, list_of(:zaryn_transfer))
  end

  @desc "[NFTLedger] represents the transfers to perform on the ZARYN ledger"
